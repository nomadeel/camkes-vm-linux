...
function(GetDefaultLinuxRootfsFile dest_file)
  if(KernelSel4ArchX86_64)
    set(
        ${dest_file} ${VM_LINUX_PROJECT_DIR}/images/rootfs/64/default_buildroot_rootfs-bare.cpio
        PARENT_SCOPE
    )
  else()
    set(
        ${dest_file} ${VM_LINUX_PROJECT_DIR}/images/rootfs/32/default_buildroot_rootfs-bare.cpio
        PARENT_SCOPE
    )
  endif()
